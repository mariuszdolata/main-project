...
public class ColumnInformation {
	...
	public ColumnInformation(String columnName, String columnType, boolean columnPK, String tableCatalog,
	...
	public String toString() {
		return "ColumnInformation [columnName=" + columnName + ", columnType=" + columnType + ", columnPK=" + columnPK
				+ ", tableName=" + tableName + "]";
	}
